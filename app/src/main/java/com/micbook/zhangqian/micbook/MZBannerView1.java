...
import com.micbook.transFormer.CoverModeTransformer;
...
public class MZBannerView1<T> extends RelativeLayout {
    ...
    public MZBannerView1(@NonNull Context context) {
        super(context);
        init();
    }

    public MZBannerView1(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        readAttrs(context,attrs);
        init();
    }

    public MZBannerView1(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    /**
     * 开始轮播
     * <p>应该确保在调用用了{@link MZBannerView1 {@link #setPages(List, MZHolderCreator)}} 之后调用这个方法开始轮播</p>
     */
    public void start(){
