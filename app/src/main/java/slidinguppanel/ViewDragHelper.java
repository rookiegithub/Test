...
//     */
//    public static com.sothree.slidinguppanel.ViewDragHelper create(ViewGroup forParent, Callback cb) {
//        return new com.sothree.slidinguppanel.ViewDragHelper(forParent.getContext(), forParent, null, cb);
//    }
//
//    /**
...
//     * @return a new ViewDragHelper instance
//     */
//    public static com.sothree.slidinguppanel.ViewDragHelper create(ViewGroup forParent, Interpolator interpolator, Callback cb) {
//        return new com.sothree.slidinguppanel.ViewDragHelper(forParent.getContext(), forParent, interpolator, cb);
//    }
//
//    /**
//     * Factory method to create a new ViewDragHelper.
...
//     * @return a new ViewDragHelper instance
//     */
//    public static com.sothree.slidinguppanel.ViewDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
//        final com.sothree.slidinguppanel.ViewDragHelper helper = create(forParent, cb);
...
//     * @return a new ViewDragHelper instance
//     */
//    public static com.sothree.slidinguppanel.ViewDragHelper create(ViewGroup forParent, float sensitivity, Interpolator interpolator, Callback cb) {
//        final com.sothree.slidinguppanel.ViewDragHelper helper = create(forParent, interpolator, cb);
//        helper.mTouchSlop = (int) (helper.mTouchSlop * (1 / sensitivity));
//        return helper;
//    }
//
